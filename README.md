...
- La barra principal conserva `Nuevo ingreso`, `Nuevo egreso`, filtros por fecha e `Imprimir`; los totales se recalculan sobre las filas visibles.
- La impresion permite elegir periodo o rango, agregar una nota para la hoja y usa el logo configurado para la empresa, con marca generica como respaldo.
