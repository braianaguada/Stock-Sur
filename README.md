...
- **PDF**: los presupuestos de servicio permiten descargar el PDF directamente desde el listado y desde el link publico, sin pasar por el dialogo de impresion del navegador. La generación se aísla de los estilos visuales de la aplicación para evitar interferencias durante la descarga.
