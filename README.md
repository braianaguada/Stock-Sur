...
- Stock, movimientos, órdenes de compra y documentos de Servicios centralizan sus etiquetas y tonos en mapas de presentación compartidos; `CountBadge`, `HealthBadge` y `CategoryBadge` conservan una anatomía única de 24 px, iconos y capitalización normal en temas claro y oscuro.
