    ...
    <main className="min-h-screen bg-background p-6 text-foreground md:p-10">
      <div className="mx-auto max-w-2xl rounded-lg border bg-card p-6 shadow-sm">
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          Faltan variables de entorno necesarias para iniciar la aplicacion.
        </p>
        ...
        <p className="mt-5 text-sm text-muted-foreground">
          Crea un archivo <code className="rounded bg-muted px-1 py-0.5">.env</code> basado en{" "}
          <code className="rounded bg-muted px-1 py-0.5">.env.example</code> y reinicia el servidor.
        </p>
      </div>
    </main>
  );
