        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => onFormChange({ ...form, customer_id: value === "__none__" ? "" : value })}
            >
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="O escribi un nombre"
            />
          </div>
        </div>
        <div className="space-y-2">
            ...
            {lines.map((line, index) => (
              <div key={index} className="flex items-start gap-2">
                ...
                <Input
                  ...
                  placeholder="Cant."
                  value={line.quantity}
                  onChange={(event) => onLineChange(index, "quantity", parseFloat(event.target.value) || 0)}
                />
                <Input
                  className="w-28"
                  type="number"
                  ...
                  onChange={(event) => onLineChange(index, "unit_price", parseFloat(event.target.value) || 0)}
                />
