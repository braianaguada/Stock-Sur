                ...
                <div className="overflow-hidden rounded-[18px] border border-slate-200">
                  ...
                  <section className="grid border-b border-slate-200 lg:grid-cols-[minmax(0,1fr)_320px]">
                    <div className="grid gap-x-5 gap-y-4 border-b border-slate-200 p-5 sm:grid-cols-2 xl:grid-cols-4 lg:border-b-0 lg:border-r">
                      ...
                      {resolveDocumentRecipient(selectedDocument, { technicianName }).secondaryName ? <PreviewField label={selectedDocument.customer_kind === "INTERNO" ? "Motivo" : "Nombre ocasional"} value={resolveDocumentRecipient(selectedDocument, { technicianName }).secondaryName} /> : null}
