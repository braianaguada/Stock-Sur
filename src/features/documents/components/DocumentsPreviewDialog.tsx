                ...
                <div className="overflow-hidden rounded-[18px] border border-slate-200">
                  ...
                  <header className="grid gap-5 border-b border-slate-200 p-5 xl:grid-cols-[minmax(0,1fr)_280px]">
                    <div className="flex min-w-0 items-center gap-5">
                      <div className="flex h-28 w-44 shrink-0 items-center justify-center rounded-2xl border border-slate-200 bg-white p-2 shadow-sm">
                        {companySettings.logo_url ? (
                          <img src={companySettings.logo_url} alt={companySettings.app_name} className="max-h-24 w-auto max-w-full object-contain" />
                        ) : (
