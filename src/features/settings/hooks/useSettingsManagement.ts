...
export function useSettingsManagement({
  ...
  const [form, setForm] = useState({
    ...
    document_tagline: "",
    document_footer: "",
    service_default_intro_text: "",
    service_default_closing_text: "",
    service_default_delivery_time: "",
    service_default_payment_terms: "",
    service_default_delivery_location: "",
    service_default_valid_days: "",
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      service_default_intro_text: settings.service_default_intro_text ?? "",
      service_default_closing_text: settings.service_default_closing_text ?? "",
      service_default_delivery_time: settings.service_default_delivery_time ?? "",
      service_default_payment_terms: settings.service_default_payment_terms ?? "",
      service_default_delivery_location: settings.service_default_delivery_location ?? "",
      service_default_valid_days: String(settings.service_default_valid_days ?? ""),
  ...
  const saveMutation = useMutation({
    mutationFn: async () => {
      ...
      const payload = {
        ...
        service_default_intro_text: form.service_default_intro_text.trim() || null,
        service_default_closing_text: form.service_default_closing_text.trim() || null,
        service_default_delivery_time: form.service_default_delivery_time.trim() || null,
        service_default_payment_terms: form.service_default_payment_terms.trim() || null,
        service_default_delivery_location: form.service_default_delivery_location.trim() || null,
        service_default_valid_days: Math.max(1, Number(form.service_default_valid_days) || 0) || null,
