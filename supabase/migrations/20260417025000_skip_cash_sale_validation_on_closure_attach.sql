...
begin
  if tg_op = 'UPDATE'
     ...
     and coalesce(old.document_id, '00000000-0000-0000-0000-000000000000'::uuid) = coalesce(new.document_id, '00000000-0000-0000-0000-000000000000'::uuid)
     and coalesce(old.receipt_kind, 'PENDIENTE'::public.cash_receipt_kind) = coalesce(new.receipt_kind, 'PENDIENTE'::public.cash_receipt_kind)
     and coalesce(old.receipt_reference, '') = coalesce(new.receipt_reference, '')
     and old.business_date = new.business_date
